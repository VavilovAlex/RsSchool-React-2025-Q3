...
export const EmissionsTable = memo(
  function EmissionsTable({
    ...
    const selectedCountryData = useMemo(
      ...
      [selectedCountry?.data, sortDataBy.direction, sortDataBy.key],
    );
    ...
    const countries = useMemo(
      () => filterCountries(countriesRaw),
      [countriesRaw, filterCountries],
    );
  ...
  (old, props) => {
    return old.dataPromise === props.dataPromise;
  },
);
